...
public class PoloniexExchangeService implements ExchangeService
{
    ...
    public List<PoloniexChartData> returnBTCChartData(Long periodInSeconds, Long startEpochInSeconds)
    {
        ...
        log.debug("Retrieved and mapped " + USDT_BTC_CURRENCY_PAIR + " chart data in " + (System.currentTimeMillis() - start) + " ms");
        return chartData;
    }
    ...
    public List<PoloniexChartData> returnETHChartData(Long periodInSeconds, Long startEpochInSeconds)
    {
        ...
        List<PoloniexChartData> chartData = mapper.mapChartData(chartDataResult);
        log.debug("Retrieved and mapped " + USDT_ETH_CURRENCY_PAIR + " chart data in " + (System.currentTimeMillis() - start) + " ms");
        return chartData;
    }
    ...
    public PoloniexTicker returnTicker(String currencyPair)
    {
        ...
        log.debug("Retrieved and mapped " + currencyPair + " ticker in " + (System.currentTimeMillis() - start) + " ms");
        return tickerResult;
    }
    ...
    public PoloniexCompleteBalance returnBalance(String currencyType)
    {
        ...
        log.debug("Retrieved and mapped " + currencyType + " complete balance in " + (System.currentTimeMillis() - start) + " ms");
        return balance;
    }
    ...
    public PoloniexFeeInfo returnFeeInfo()
    {
        ...
        log.debug("Retrieved and mapped Poloniex fee info in " + (System.currentTimeMillis() - start) + " ms");
        return feeInfo;
    }
    ...
    public List<PoloniexOpenOrder> returnOpenOrders(String currencyPair)
    {
        ...
        log.debug("Retrieved and mapped " + currencyPair + " open orders in " + (System.currentTimeMillis() - start) + " ms");
        return openOrders;
    }
    ...
    public List<PoloniexTradeHistory> returnTradeHistory(String currencyPair)
    {
        ...
        log.debug("Retrieved and mapped " + currencyPair + " trade history in " + (System.currentTimeMillis() - start) + " ms");
        return tradeHistory;
    }
    ...
    public PoloniexOrderResult sell(String currencyPair, BigDecimal sellPrice, BigDecimal amount, boolean fillOrKill, boolean immediateOrCancel, boolean postOnly)
    {
        ...
        log.debug("Retrieved and mapped " + currencyPair + " sell order in " + (System.currentTimeMillis() - start) + " ms");
        return orderResult;
    }
    ...
    public PoloniexOrderResult buy(String currencyPair, BigDecimal buyPrice, BigDecimal amount, boolean fillOrKill, boolean immediateOrCancel, boolean postOnly)
    {
        ...
        log.debug("Retrieved and mapped " + currencyPair + " buy order in " + (System.currentTimeMillis() - start) + " ms");
        return orderResult;
    }
    ...
    public boolean cancelOrder(String orderNumber)
    {
        ...
        log.debug("Retrieved and mapped cancel order for " + orderNumber + " in " + (System.currentTimeMillis() - start) + " ms");
        return success;
    }
